''' 
    This is a multi-functional command-line application (OpenNCL v3.0) that I developed using Python and Ruby.
    OpenNCL (Open New Command Line OS 3.0)
    Author: ChenTom2016
    Environment: Windows + Python + Ruby
    Last Updated: January 2, 2026, 15:05
